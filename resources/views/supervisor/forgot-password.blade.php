...
<head>
    ...
    <title>Supervisor Password Reset - ROOTS</title>
...
<body>
    <div class="reset-container">
        ...
        <div class="reset-title">Supervisor Password Reset</div>
        @if(session('status'))
        ...
        @endif
        <form method="POST" action="{{ route('supervisor.forgot-password') }}">
            @csrf
            <div class="mb-3">
        ...
        <div class="text-center mt-3">
            <a href="/supervisor/login" class="text-decoration-none text-secondary">&larr; Back to Login</a>
        </div>
    </div>
