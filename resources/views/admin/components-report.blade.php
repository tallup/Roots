...
<head>
    ...
    <title>Components Report - ROOTS</title>
...
<div class="main-content-fixed">
    <div class="components-report-container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="page-title mb-0">Components Report</h2>
        ...
        <div class="table-responsive">
            <table id="componentsReportTable" class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th>No</th>
...
$(document).ready(function() {
    $('#componentsReportTable').DataTable({
        responsive: true,
        pageLength: 25,
        order: [[0, 'asc']],
        dom: 'Bfrtip',
