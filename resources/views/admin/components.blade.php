...
<div class="main-content-fixed">
    <div class="components-container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="page-title mb-0">Components</h2>
            <div class="d-flex gap-2">
                <a href="{{ route('admin.components-report') }}" class="btn btn-secondary">
                    <i class="fa fa-file-alt me-2"></i>View Report
                </a>
                <a href="{{ route('admin.add-component') }}" class="btn btn-primary">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <a href="{{ route('admin.edit-component', $component->compId) }}" 
                                   class="btn btn-sm btn-edit">
                                    <i class="fa fa-edit"></i> Edit
                                </a>
                                <button type="button" class="btn btn-danger btn-sm delete-component" 
...
$(document).on('click', '.delete-component', function() {
    ...
    if (confirm('Are you sure you want to delete the component "' + name + '"?')) {
        ...
        form.method = 'POST';
        form.action = '{{ url("/admin/delete-component") }}/' + id;
