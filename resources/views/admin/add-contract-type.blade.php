...
<head>
    ...
    <title>Add Contract Type - ROOTS</title>
...
<div class="main-content-fixed">
    <div class="add-contract-type-container">
        <h2 class="form-title">Add Contract Type</h2>
        @if(session('success'))
        ...
        @endif
        <form method="POST" action="{{ route('admin.add-contract-type.store') }}">
            @csrf
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="contractType" name="contractType" 
                       value="{{ old('contractType') }}" placeholder="Enter contract type" required>
            </div>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary flex-grow-1">Add Contract Type</button>
