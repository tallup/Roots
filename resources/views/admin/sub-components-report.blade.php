...
<head>
    ...
    <title>Sub-Components Report - ROOTS</title>
    ...
    <style>
        ...
        .sub-components-report-container {
            background: #fff;
            border-radius: 15px;
...
<div class="main-content-fixed">
    <div class="sub-components-report-container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="page-title mb-0">Sub-Components Report</h2>
        ...
        <div class="table-responsive">
            <table id="subComponentsReportTable" class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th>No</th>
...
$(document).ready(function() {
    $('#subComponentsReportTable').DataTable({
        responsive: true,
        pageLength: 25,
        order: [[0, 'asc']],
        dom: 'Bfrtip',
