...
<head>
    ...
    <title>Edit Indicator Description - ROOTS</title>
    ...
    <style>
        ...
        .edit-indicator-description-container {
            background: #fff;
            border-radius: 15px;
...
<div class="main-content-fixed">
    <div class="edit-indicator-description-container">
        <h2 class="form-title">Edit Indicator Description</h2>
        @if(session('success'))
        ...
        @endif
        <form method="POST" action="{{ route('admin.edit-indicator-description.update', $indicatorDescription->descid) }}">
            @csrf
            <div class="mb-3">
                ...
                <select class="form-select" id="indi_id" name="indi_id" required>
                    ...
                    @foreach($indicatorTypes as $indicatorType)
                        <option value="{{ $indicatorType->indicatorId }}" 
                                {{ old('indi_id', $indicatorDescription->indi_id) == $indicatorType->indicatorId ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control form-textarea" id="description" name="description" 
                          placeholder="Enter indicator description" required>{{ old('description', $indicatorDescription->description) }}</textarea>
            </div>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary flex-grow-1">Update Description</button>
