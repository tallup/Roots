                ...
                <div class="card-header" style="background: linear-gradient(90deg, #00796b 0%, #00bcd4 100%); color: white;">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">
                            <i class="fa fa-graduation-cap me-2"></i>Training Performance Monitoring - Admin View
                        </h4>
                        ...
                        <table id="trainingsTable" class="table table-striped table-bordered">
                            <thead style="background: linear-gradient(90deg, #00796b 0%, #00bcd4 100%); color: white;">
                                <tr>
                                    ...
                                    <th>Total Targeted Beneficiary</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format((float)($training->cost ?? 0)) }}</td>
                                    <td>{{ $training->train_desc ?? '' }}</td>
                                    <td>{{ number_format((int)($training->total_target ?? 0)) }}</td>
                                    <td>{{ number_format((int)($training->total_acheived ?? 0)) }}</td>
...
$(document).ready(function() {
    $('#trainingsTable').DataTable({
        ...
        columnDefs: [
            ...
            {
                targets: [7, 8, 9], // Actor Type, Person, Venue
                width: '100px'
            },
            {
                targets: [10], // Training Cost
                width: '100px',
                className: 'text-center'
            },
            {
                targets: [11], // Training Description
                width: '200px'
            },
            {
                targets: [12, 13], // Total Targeted, Total Achieved
                width: '120px',
                className: 'text-center'
            },
            {
                targets: [14, 15], // Key Issues, Recommendation
                width: '150px'
            },
            {
                targets: [16], // Remarks
...
function exportToCSV() {
    ...
    link.download = 'trainings_report.csv';
    link.click();
}
