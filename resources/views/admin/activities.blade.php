...
<div class="main-content-fixed">
    <div class="activities-container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="page-title mb-0">Activities</h2>
            <div class="d-flex gap-2">
                <a href="{{ route('admin.activities-report') }}" class="btn btn-secondary">
                    <i class="fa fa-file-alt me-2"></i>View Report
                </a>
                <a href="{{ route('admin.add-activity') }}" class="btn btn-primary">
                    <i class="fa fa-plus me-2"></i>Add New Activity
                </a>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <a href="{{ route('admin.edit-activity', $activity->activity_id) }}" 
...
$(document).on('click', '.delete-activity', function() {
    ...
    if (confirm('Are you sure you want to delete the activity "' + name + '"?')) {
        ...
        form.method = 'POST';
        form.action = '{{ url("/admin/delete-activity") }}/' + id;
