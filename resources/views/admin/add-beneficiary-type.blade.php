...
<head>
    ...
    <title>Add Beneficiary Type - ROOTS</title>
    ...
    <style>
        ...
        .add-beneficiary-type-container {
            background: #fff;
            border-radius: 15px;
...
<div class="main-content-fixed">
    <div class="add-beneficiary-type-container">
        <h2 class="form-title">Add Beneficiary Type</h2>
        @if(session('success'))
        ...
        @endif
        <form method="POST" action="{{ route('admin.add-beneficiary-type.store') }}">
            @csrf
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="beneficiary_type" name="beneficiary_type" 
                       value="{{ old('beneficiary_type') }}" placeholder="Enter beneficiary type" required>
            </div>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary flex-grow-1">Add Beneficiary Type</button>
