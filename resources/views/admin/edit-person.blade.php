...
<div class="main-content-fixed">
    <div class="edit-person-container">
        <h2 class="page-title">Edit Person</h2>
        ...
        <form method="POST" action="{{ route('admin.edit-person.update', $person->personId) }}">
            @csrf
                ...
                <select class="form-select @error('actorId') is-invalid @enderror" 
                    ...
                    @foreach($actors as $actor)
                        <option value="{{ $actor->Actor_name }}" 
                                {{ old('actorId', $person->actorId) == $actor->Actor_name ? 'selected' : '' }}>
                            {{ $actor->Actor_name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="d-flex gap-3 justify-content-center">
                <button type="submit" class="btn btn-primary">
                    <i class="fa fa-save me-2"></i>Update Person
                </button>
                <a href="{{ route('admin.persons') }}" class="btn btn-secondary">
