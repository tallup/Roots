...
<div class="main-content-fixed">
    <div class="contractors-container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="page-title mb-0">Contractors</h2>
            <div class="d-flex gap-2">
                <a href="{{ route('admin.contractors-report') }}" class="btn btn-secondary">
                    <i class="fa fa-file-alt me-2"></i>View Report
                </a>
                <a href="{{ route('admin.add-contractor') }}" class="btn btn-primary">
                    <i class="fa fa-plus me-2"></i>Add New Contractor
                </a>
            </div>
        </div>
            ...
            <table id="contractorsTable" class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $contractor->implementing_partner ? $contractor->implementing_partner : 'N/A' }}</td>
                        <td>
                            <div class="d-flex gap-1">
                                <a href="{{ route('admin.edit-contractor', $contractor->contractorId) }}" 
                                   class="btn btn-sm btn-edit">
                                    <i class="fa fa-edit"></i> Edit
                                </a>
                                <button type="button" class="btn btn-danger btn-sm delete-contractor" 
                                        data-id="{{ $contractor->contractorId }}" 
                                        data-name="{{ $contractor->contractorName }}">
...
$(document).on('click', '.delete-contractor', function() {
    ...
    if (confirm('Are you sure you want to delete the contractor "' + name + '"?')) {
        // Create a form to submit the delete request
        const form = document.createElement('form');
        form.method = 'POST';
        form.action = '{{ url("/admin/delete-contractor") }}/' + id;
