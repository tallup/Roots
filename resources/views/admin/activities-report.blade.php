...
<head>
    ...
    <title>Activities Report - ROOTS</title>
...
<div class="main-content-fixed">
    <div class="activities-report-container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="page-title mb-0">Activities Report</h2>
        ...
        <div class="table-responsive">
            <table id="activitiesReportTable" class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Activity Name</th>
