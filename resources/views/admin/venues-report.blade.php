...
<head>
    ...
    <title>Venues Report - ROOTS</title>
...
<div class="main-content-fixed">
    <div class="venues-report-container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="page-title mb-0">Venues Report</h2>
        ...
        <div class="table-responsive">
            <table id="venuesReportTable" class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Venue Name</th>
