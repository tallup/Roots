...
<div class="main-content-fixed">
    <div class="add-finance-container">
        <h2 class="form-title">Add Finance User</h2>
        @if(session('success'))
        ...
        @endif
        <form method="POST" action="{{ route('admin.add-finance.store') }}">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="mobileNo" name="mobileNo" value="{{ old('mobileNo') }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary w-100">Add Finance User</button>
        </form>
    </div>
</div>
