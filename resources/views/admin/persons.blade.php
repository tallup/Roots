...
<div class="main-content-fixed">
    <div class="persons-container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="page-title mb-0">Focal Points</h2>
            <div class="d-flex gap-2">
                <a href="{{ route('admin.persons-report') }}" class="btn btn-secondary">
                    <i class="fa fa-file-alt me-2"></i>View Report
                </a>
                <a href="{{ route('admin.add-person') }}" class="btn btn-primary">
                    <i class="fa fa-plus me-2"></i>Add New Person
                </a>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table id="personsTable" class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Name</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        <td>{{ $person->Name }}</td>
                        <td>{{ $person->implementing_partner ? $person->implementing_partner : 'N/A' }}</td>
                        <td>
                            <div class="d-flex gap-1">
                                <a href="{{ route('admin.edit-person', $person->personId) }}" 
...
$(document).on('click', '.delete-person', function() {
    ...
    if (confirm('Are you sure you want to delete the person "' + name + '"?')) {
        ...
        form.method = 'POST';
        form.action = '{{ url("/admin/delete-person") }}/' + id;
