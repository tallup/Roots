...
<head>
    ...
    <title>Edit Component - ROOTS</title>
...
<div class="main-content-fixed">
    <div class="edit-component-container">
        <h2 class="page-title">Edit Component</h2>
        ...
        <form method="POST" action="{{ route('admin.edit-component.update', $component->compId) }}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control @error('component_name') is-invalid @enderror" 
                       id="component_name" name="component_name" value="{{ old('component_name', $component->component_name) }}" 
            ...
            <div class="d-flex gap-3 justify-content-center">
                <button type="submit" class="btn btn-primary">
                    <i class="fa fa-save me-2"></i>Update Component
                </button>
