...
<head>
    ...
    <title>Edit Activity - ROOTS</title>
...
<div class="main-content-fixed">
    <div class="edit-activity-container">
        ...
        @endif
        <form method="POST" action="{{ route('admin.edit-activity.update', $activity->activity_id) }}">
            @csrf
            <div class="mb-3">
                <label for="activity_name" class="form-label">Activity Name</label>
                <input type="text" class="form-control" id="activity_name" name="activity_name" 
                       value="{{ old('activity_name', $activity->activity_name) }}" placeholder="Enter activity name" required>
            </div>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary flex-grow-1">Update Activity</button>
