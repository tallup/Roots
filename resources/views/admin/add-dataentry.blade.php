...
<head>
    ...
    <title>Add Data Entry - ROOTS</title>
...
<div class="main-content-fixed">
    <div class="add-dataentry-container">
        <h2 class="form-title">Add Data Entry User</h2>
        @if(session('success'))
        ...
        @endif
        <form method="POST" action="{{ route('admin.add-dataentry.store') }}">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="Workphnumber" name="Workphnumber" value="{{ old('Workphnumber') }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary w-100">Add Data Entry User</button>
        </form>
    </div>
</div>
