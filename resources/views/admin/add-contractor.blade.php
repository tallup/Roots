...
<head>
    ...
    <title>Add Contractor - ROOTS</title>
...
<div class="main-content-fixed">
    <div class="add-contractor-container">
        <h2 class="page-title">Add Contractor</h2>
        ...
        <form method="POST" action="{{ route('admin.add-contractor.store') }}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control @error('contractorName') is-invalid @enderror" 
                       id="contractorName" name="contractorName" value="{{ old('contractorName') }}" 
            ...
            <div class="mb-4">
                ...
                <select class="form-select @error('actorId') is-invalid @enderror" 
                    ...
                    @foreach($actors as $actor)
                        <option value="{{ $actor->Actor_name }}" {{ old('actorId') == $actor->Actor_name ? 'selected' : '' }}>
                            {{ $actor->Actor_name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="d-flex gap-3 justify-content-center">
                <button type="submit" class="btn btn-primary">
                    <i class="fa fa-save me-2"></i>Save Contractor
                </button>
