...
<head>
    ...
    <title>Add Payment Tranche - ROOTS</title>
...
<div class="main-content-fixed">
    <div class="add-payment-tranche-container">
        <h2 class="page-title">Add Payment Tranche</h2>
        ...
        <form method="POST" action="{{ route('admin.add-payment-tranche.store') }}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control @error('pay_tranche') is-invalid @enderror" 
                       id="pay_tranche" name="pay_tranche" value="{{ old('pay_tranche') }}" 
            ...
            <div class="d-flex gap-3 justify-content-center">
                <button type="submit" class="btn btn-primary">
                    <i class="fa fa-save me-2"></i>Save Payment Tranche
                </button>
