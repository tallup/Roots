...
<head>
    ...
    <title>Add Contract Performance - ROOTS Data Entry</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dataentry.dashboard') }}">
                            <i class="fa fa-tachometer-alt me-1"></i>Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dataentry.beneficiaries') }}">
                            <i class="fa fa-users me-1"></i>Beneficiary
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dataentry.indicators') }}">
                            <i class="fa fa-chart-line me-1"></i>Indicator
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('dataentry.contracts') }}">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                            <i class="fa fa-user me-1"></i>{{ session('dataentry_name') }}
                        </a>
                        <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('dataentry.profile') }}"><i class="fa fa-user-cog me-2"></i>Profile</a></li>
                            <li><a class="dropdown-item" href="{{ route('dataentry.settings') }}"><i class="fa fa-cog me-2"></i>Settings</a></li>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="form-card">
                <h2 class="form-title">
                    <i class="fa fa-file-contract me-2"></i>Add Contract/MOU Performance
                </h2>
                <form method="POST" action="{{ route('dataentry.add-contract.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-4">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="component" name="component" required>
                                ...
                                @foreach($components as $component)
                                    <option value="{{ $component->compId }}">{{ $component->component_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="subcomponent" name="subcomponent" required>
                                ...
                                @foreach($subcomponents as $subcomponent)
                                    <option value="{{ $subcomponent->subId }}">{{ $subcomponent->sub_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="actor" name="actor" required>
                                ...
                                @foreach($actors as $actor)
                                    <option value="{{ $actor->Actor_name }}">{{ $actor->Actor_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="intervention" name="intervention" required>
                                ...
                                @foreach($interventions as $intervention)
                                    <option value="{{ $intervention->intervention_type }}">{{ $intervention->intervention_type }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="cost" name="cost" placeholder="Enter cost" step="0.01" required>
                        </div>
                        <div class="col-md-6">
                            <label for="key_issue" class="form-label required">Key Issues</label>
                            <textarea class="form-control" id="key_issue" name="key_issue" rows="2" placeholder="Enter key issues" required></textarea>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label for="recommendation" class="form-label required">Recommendation</label>
                            <textarea class="form-control" id="recommendation" name="recommendation" rows="3" placeholder="Enter recommendations" required></textarea>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <button type="submit" class="btn btn-primary btn-lg" name="submit" id="submit">
                                <i class="fa fa-save me-2"></i>Add Contract Performance
                            </button>
...
$(document).ready(function() {
    ...
    // On page load, prefill if old input exists
    var initialComponent = $('#component').val();
    var initialSubcomponent = '{{ old("subcomponent") }}';
    if (initialComponent) {
